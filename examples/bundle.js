...
/***/ function(module, exports, __webpack_require__) {
	...
	var Timeline = _react2.default.createClass({
	    ...
	    _handdleDrag: function _handdleDrag(event) {
	        ...
	        var cursorSize = 100;
	        var translateValue = event.clientX - this.maxCursor.offsetLeft;
	    ...
	    _getAvailableYearsHtml: function _getAvailableYearsHtml(min, max) {
	        ...
	        for (min; min <= max; min++) {
	            html.push(_react2.default.createElement(
	                'div',
	                { className: 'time-block', style: style, key: 'year-' + min },
	                min
	            ));
	        }
	    ...
	    _handleMouseDown: function _handleMouseDown(cursor) {
	        var _this3 = this;
