...
/***/ function(module, exports, __webpack_require__) {
	...
	var Timeline = _react2.default.createClass({
	    ...
	    _setWindowVars: function _setWindowVars() {
	        var time = this.props.maxTime - this.props.minTime;
	    ...
	    _updateValue: function _updateValue() {
	        ...
	        var minCursorDate = this.props.minTime + parseInt(this.state.minCursorX / this.state.timeScale);
	        var maxCursorDate = this.props.minTime + parseInt(this.state.maxCursorX / this.state.timeScale);
